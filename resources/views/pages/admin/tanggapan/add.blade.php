    ...
    <form action="{{ route('tanggapan.store')}} " method="POST" enctype="multipart/form-data">
      ...
      <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
        ...
        <label class="block mt-4 text-sm">
          <span class="text-gray-700 dark:text-gray-400">Pihak Terkait</span>
          ...
          <select
            ...
            <option value="PLN Kac.Laut Tador">Pln Kac.laut Tador</option>
            <option value="Dinas Kab.Batubara">Dinas Kab.Batubara</option>
            <option value="Pemerintah Setempat">Pemerintah Setempat</option>
