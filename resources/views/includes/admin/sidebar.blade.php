...
<aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
  ...
  <div class="container mx-auto px-4 mt-6 flex items-center justify-center">
    <img class="bg-center bg-cover" width="70" height="500" src="{{ asset('assets/img/logo.png')}}" alt="" class="inline-flex ml-3 items-center transform transition hover:scale-125 duration-300 ease-in-out" />
    ...
    <ul>
      <li class="relative px-6 py-3">
        <span
          class="{{ (request()->is('admin/arikel')) ? 'absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg' : '' }} "
          aria-hidden="true"></span>
        <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
